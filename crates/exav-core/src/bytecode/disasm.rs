...
const X86OPS: &[&str] = &[
    "INVALID", "AAA", "AAD", "AAM", "AAS", "ADD", "ADC", "AND", "ARPL", "BOUND", "BSF", "BSR",
    "BSWAP", "BT", "BTC", "BTR", "BTS", "CALL", "CDQ", "CWD", "CWDE", "CBW", "CLC", "CLD", "CLI",
    "CLTS", "CMC", "CMOVO", "CMOVNO", "CMOVC", "CMOVNC", "CMOVZ", "CMOVNZ", "CMOVBE", "CMOVA",
    "CMOVS", "CMOVNS", "CMOVP", "CMOVNP", "CMOVL", "CMOVGE", "CMOVLE", "CMOVG", "CMP", "CMPSD",
    "CMPSW", "CMPSB", "CMPXCHG", "CMPXCHG8B", "CPUID", "DAA", "DAS", "DEC", "DIV", "ENTER", "FWAIT",
    "HLT", "IDIV", "IMUL", "INC", "IN", "INSD", "INSW", "INSB", "INT", "INT3", "INTO", "INVD",
    "INVLPG", "IRET", "JO", "JNO", "JC", "JNC", "JZ", "JNZ", "JBE", "JA", "JS", "JNS", "JP", "JNP",
    "JL", "JGE", "JLE", "JG", "JMP", "LAHF", "LAR", "LDS", "LES", "LFS", "LGS", "LEA", "LEAVE",
    "LGDT", "LIDT", "LLDT", "PREFIX_LOCK", "LODSD", "LODSW", "LODSB", "LOOP", "LOOPE", "LOOPNE",
    "JECXZ", "LSL", "LSS", "LTR", "MOV", "MOVSD", "MOVSW", "MOVSB", "MOVSX", "MOVZX", "MUL", "NEG",
    "NOP", "NOT", "OR", "OUT", "OUTSD", "OUTSW", "OUTSB", "PUSH", "PUSHAD", "PUSHA", "PUSHFD",
    "PUSHF", "POP", "POPAD", "POPFD", "POPF", "RCL", "RCR", "RDMSR", "RDPMC", "RDTSC", "PREFIX_REPE",
    "PREFIX_REPNE", "RETF", "RETN", "ROL", "ROR", "RSM", "SAHF", "SAR", "SBB", "SCASD", "SCASW",
    "SCASB", "SETO", "SETNO", "SETC", "SETNC", "SETZ", "SETNZ", "SETBE", "SETA", "SETS", "SETNS",
    "SETP", "SETNP", "SETL", "SETGE", "SETLE", "SETG", "SGDT", "SIDT", "SHL", "SHLD", "SHR", "SHRD",
    "SLDT", "STOSD", "STOSW", "STOSB", "STR", "STC", "STD", "STI", "SUB", "SYSCALL", "SYSENTER",
    "SYSEXIT", "SYSRET", "TEST", "UD2", "VERR", "VERRW", "WBINVD", "WRMSR", "XADD", "XCHG", "XLAT",
    "XOR", "PREFIX_OPSIZE", "PREFIX_ADDRSIZE", "PREFIX_SEGMENT", "2BYTE", "FPU", "F2XM1", "FABS",
    "FADD", "FADDP", "FBLD", "FBSTP", "FCHS", "FCLEX", "FCMOVB", "FCMOVBE", "FCMOVE", "FCMOVNB",
    "FCMOVNBE", "FCMOVNE", "FCMOVNU", "FCMOVU", "FCOM", "FCOMI", "FCOMIP", "FCOMP", "FCOMPP", "FCOS",
    "FDECSTP", "FDIV", "FDIVP", "FDIVR", "FDIVRP", "FFREE", "FIADD", "FICOM", "FICOMP", "FIDIV",
    ...
    "FMUL", "FMULP", "FNOP", "FPATAN", "FPREM", "FPREM1", "FPTAN", "FRNDINT", "FRSTOR", "FSCALE",
    "FSIN", "FSINCOS", "FSQRT", "FSAVE", "FST", "FSTCW", "FSTENV", "FSTP", "FSTSW", "FSUB", "FSUBP",
    "FSUBR", "FSUBRP", "FTST", "FUCOM", "FUCOMI", "FUCOMIP", "FUCOMP", "FUCOMPP", "FXAM", "FXCH",
    "FXTRACT", "FYL2X", "FYL2XP1",
];

/// `enum X86REGS` names in order; the index is the register value.
const X86REGS: &[&str] = &[
    "EAX", "ECX", "EDX", "EBX", "ESP", "EBP", "ESI", "EDI", "AX", "CX", "DX", "BX", "SP", "BP", "SI",
    "DI", "AH", "CH", "DH", "BH", "AL", "CL", "DL", "BL", "ES", "CS", "SS", "DS", "FS", "GS", "CR0",
    "CR1", "CR2", "CR3", "CR4", "CR5", "CR6", "CR7", "DR0", "DR1", "DR2", "DR3", "DR4", "DR5", "DR6",
    "DR7", "ST0", "ST1", "ST2", "ST3", "ST4", "ST5", "ST6", "ST7",
];
